    ...
    <div class="card shadow-professional-lg p-8">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600">
          Sign in to access your account and connect with trusted contractors
        </p>
      </div>
      ...
      <div class="space-y-4">
        <button
          ...
          class="btn btn-primary w-full btn-lg shadow-professional hover:shadow-professional-lg transition-all duration-200"
        >
          {#if loadingFacebook}
        ...
        <button
          ...
          class="btn btn-outline w-full btn-lg flex items-center justify-center"
        >
          {#if loadingGoogle}
